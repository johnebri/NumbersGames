...
<script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.0/js/bootstrap.min.js"></script>
	...
	<title>ThunderBalls 5 Matches</title>
...
<div class="container" style="margin-top: 20px;">
	<div class="row">
		...
		<a href="thunderballs.php">
			<button class="btn btn-default">Thunderballs 4 Matches</a>
		</a>
	</div>
</div>
...
<?php
	...
	echo '<h2>ThunderBall as at 26-10-2019</h2>';
    ...
    if($dupFound == 0) 
    {
		...
		for($i=$startRow; $i<=count($rowArr); $i++) {
			...
			/*if ($matchCount ==4) {
				...
				echo '=><span class="odd">'.$strangeNo1.'</span>';
				echo '<br>';
				...
				echo '=><span class="odd">'.$strangeNo2.'</span>';
