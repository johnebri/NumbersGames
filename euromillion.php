...
<div class="container" style="margin-top: 20px;">
	<div class="row">
		...
		<a href="index.php">
			...
			<a href="euromillion4.php">
			<button class="btn btn-default">Euromillion 4 Matches</a>
		</a>
	</div>
</div>
...
<?php
	...
	echo '<h2>Euromillion 3 Matches as at 25-10-2019</h2>';
    ...
    if($dupFound == 0) 
    {
		...
		for($i=$startRow; $i<=count($rowArr); $i++) {
			...
			if ($matchCount == 3) {
				...
				// second strange no in the top row
				for ($a=0; $a<5; $a++) {
				    // skip the previous strange no
				    if($rowArr[$rowCount][$a] == $strangeNo11) {
				        continue;
				    }
				...
				// get the second strange no in the bottom row
				for ($a=0; $a<5; $a++) {
				    // skipt the previous strange no
				    if($rowArr[$i][$a] == $strangeNo21) {
				        continue;
				    }
					if(    $rowArr[$i][$a] == $rowArr[$rowCount][0]
						|| $rowArr[$i][$a] == $rowArr[$rowCount][1]
				...
				echo '<span class="odd">'.$strangeNo12.'</span>';
				echo '<br>';
				...
				echo '<span class="odd">'.$strangeNo22.'</span>';
